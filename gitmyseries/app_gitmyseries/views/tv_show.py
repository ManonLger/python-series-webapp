...
def tv_show(request, tmdb_id):
    ...
    next_episode = tv_show.get_next_episode_run_time #get the next_episode date
    ...
    return render(request, 'app_gitmyseries/tv_show.html', locals()) #return to the tv_show template
